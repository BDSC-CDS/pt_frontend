    ...
    return (
        <div className='bg-white text-[#306278]'>
            ...
            <div className="flex min-h-screen">
                ...
                <main className="ml-64 mt-10 flex-1 flex flex-col items-center justify-center">
                    <div className='bg-[#eaeff1] w-2/3 h-3/4 rounded flex flex-col items-center justify-center py-10'>
